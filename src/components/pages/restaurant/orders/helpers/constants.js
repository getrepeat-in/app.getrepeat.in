...
export const ORDER_TAB_FILTERS = [
    ...
    { key: "active", label: "Active", statuses: ["PLACED", "ACCEPTED", "PREPARING", "READY"] },
...
export const FULFILLMENT_STATUS_CONFIG = {
    PENDING: { label: "Pending", badge: "bg-gray-100 text-gray-700 border-gray-200 dark:bg-zinc-800 dark:text-gray-300", dot: "bg-gray-500" },
    READY: { label: "Ready", badge: "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950 dark:text-amber-400", dot: "bg-amber-500" },
    ...
    FULFILLED: { label: "Fulfilled", badge: "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950 dark:text-emerald-400", dot: "bg-emerald-500" }
};
